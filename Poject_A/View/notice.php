	...
	<div class="row">
	  <div class="column side">
	    <div class="card_side">
	    	<div class="side">
	    		<table>
	    			<tr><td><a href="#">All Notice</a></td></tr>
	    			<tr><td><a href="upd_notice.php">Update Notice</a></td></tr>
	    		</table>
	    	</div>
	    </div>
	  </div>
	  <div class="column middle">
	  			...
	  			<table>
	  				...
	  				<tr>
	  					<td>
	  						...
	  						<input type="submit" name="btn_upload" id="btn_upload" value="Upload Notice">
	  					</td>
	  				</tr>
	  			</table>
	  		</form>
	  	...
	  	<?php
			include("../Control/noticecontrol.php");
		?>
	  </div>
	</div>
</body>
